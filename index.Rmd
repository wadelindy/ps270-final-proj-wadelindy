...
govttrustplot
```
The graph above, showing general American trust in government over the years 1997-2022, demonstrates a broad pattern of decrease in government trust; the big spike in the early 2000's is a clear outlier which is attributable to broad American support for the George W. Bush administration following the terrorist attacks on September 11, 2001. 

However, it is clear that trust in government over the time period trends significantly downwards over time; as with media, let's observe partisan trends to see if there's a better mechanism of understanding this data.
